  ...
  return (
    <article className="event-card" data-featured={featured || undefined}>
      ...
      <div className="event-card__body">
        ...
        <Link className="text-link" href={`/events/${event.slug}/`} aria-label={`Plan your visit: ${event.title}`} data-analytics-event="event_opened" data-analytics-label={event.slug} data-analytics-position="card_cta">Plan your visit <span aria-hidden="true">→</span></Link>
      </div>
    </article>
  )
}
