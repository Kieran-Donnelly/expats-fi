...
const titleOverrides: Record<string, string> = {
  ...
  'employment-foreign_qualifications': 'Recognition of foreign qualifications in Finland',
  'employment-finding_work': 'Finding a job in Finland: a practical guide for internationals',
  'employment-finnish_labour_market': 'The Finnish job market: sectors, language and local realities',
  'employment-employment_services': 'Job Market Finland and local employment services',
  'employment-eures_employment_service': 'EURES Finland: finding work across Europe',
  'employment-te_employment_service': 'Job Market Finland and local employment services',
  'employment-wages_conditions': 'Pay, working hours and employment conditions in Finland',
  'employment-employment_contract': 'Finnish employment contracts: what to check before signing',
  'employment-employment_law_and_disputes': 'Employment rights and workplace disputes in Finland',
  'employment-unions': 'Trade unions and unemployment funds in Finland',
