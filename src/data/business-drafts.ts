...
export const businessDrafts: BusinessDraft[] = [
  ...
  {
    slug: 'vacek-valmennus',
    name: 'Vacek Valmennus',
    summary: 'Personal training, remote coaching and outdoor sessions across Helsinki, led by Matej Vacek, an experienced personal trainer and physiotherapist working in English, Finnish and Czech.',
    description: "Moving countries usually gives you enough to deal with without also rebuilding your knee, but that is more or less where Matej Vacek's Finland story began.\n\nMatej moved from Prague to Helsinki in 2005 looking for a fresh start. A few months earlier, he had injured his ACL and been told he would not be able to play sport at the highest level again. Finland gave him the reset he was after. He got back into floorball, met his wife that same year and, somewhere along the way, Helsinki stopped being the new place and became home.\n\nSport and movement remained a big part of his life. Matej qualified as a personal trainer in 2012, started his own business in 2017 and graduated from Metropolia as a physiotherapist in spring 2026.\n\nThrough Vacek Valmennus, he offers personal training that is built around the person rather than handing everybody the same programme. That could mean getting stronger, returning to regular exercise, working on mobility, rebuilding your confidence or simply finding a routine that fits around work and family life.\n\nSessions can take place at Liikuntamylly, Töölön Kisahalli or Helsinki Core Trainers. Matej also offers home and remote coaching, outdoor training and sessions at other agreed locations around the capital region.\n\nHe coaches in English, Finnish and Czech, which is very handy when you would rather focus on the exercise than try to remember the Finnish word for hamstring halfway through a session.\n\nMatej now lives in Myllypuro with his wife, their three children and two cats. More than twenty years after arriving for a fresh start of his own, he is helping other people get moving, feel stronger and find a way of training they can actually stick with.\n\nIf you have been putting off exercise because gyms feel intimidating, an old injury has made you cautious or you simply do not know where to begin, Matej is a very good person to have in your corner.",
    categories: ['Health & wellbeing', 'Fitness & training', 'Personal training'],
    locations: ['Helsinki', 'Espoo', 'Vantaa'],
    address: 'Liikuntamylly, Töölön Kisahalli, Helsinki Core Trainers, outdoors and agreed locations across the Helsinki metropolitan area',
    website: 'https://vacek-valmennus.com/en/',
    phone: '+358 40 965 4969',
    instagramHandle: '@coach_matej',
    instagram: 'https://www.instagram.com/coach_matej/',
    imagePath: '/businesses/vacek-valmennus/matej-training.jpg',
    imageAlt: 'Matej Vacek training on outdoor parallel bars beside the water in Helsinki',
    logoPath: '/businesses/vacek-valmennus/logo.jpg',
  ...
  },
  {
    ...
    imagePath: '/businesses/vitaldon-therapy/don-raduma.jpg',
    imageAlt: 'Don Raduma, the licensed massage therapist behind Vitaldon Therapy',
  ...
  },
  {
    slug: 'mik-oy',
    name: 'Mik Oy',
    summary: 'A Järvenpää-based team helping with moving, deliveries and cleaning across Uusimaa and Lahti.',
    description: 'Laurene Dajac started Mik Oy in 2022 after losing her job and seeing first-hand how difficult it can be to find work when you are still getting established in Finland. She wanted to create jobs for people willing to have a go, while building a company customers could rely on. Mik Oy now helps homes and businesses with moves, deliveries, home and office cleaning, window cleaning and move-in or move-out cleaning. They are based in Järvenpää and work across Uusimaa and Lahti.',
    categories: ['Home services', 'Moving & delivery', 'Cleaning'],
    locations: ['Järvenpää', 'Uusimaa', 'Lahti'],
    address: 'Based in Järvenpää; serving Uusimaa and Lahti',
    website: 'https://mikoy.fi/en/',
    instagramHandle: '@mik_dajac_oy',
    instagram: 'https://www.instagram.com/mik_dajac_oy/',
    facebook: 'https://www.facebook.com/profile.php?id=61573467868041',
    logoPath: '/businesses/mik-oy/logo.png',
    logoAlt: 'Mik Oy logo',
    status: 'published',
  },
]
