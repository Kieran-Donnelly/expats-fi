...
export const events: CityEvent[] = [
  ...
  {
    slug: 'relaxed-basketball-puistola-2026',
    title: 'Relaxed Basketball',
    category: 'Sports & outdoors',
    startDate: '2026-09-03',
    endDate: '2026-10-07',
    dateLabel: 'Thursdays, 3 September–7 October',
    timeLabel: '18:00–20:00',
    location: 'Puistola Church gym hall',
    address: 'Tenavatie 4, 00760 Helsinki',
    district: 'Puistola',
    coordinates: { latitude: 60.2757, longitude: 25.0468 },
    blurb: 'A free weekly basketball session for 12 to 18-year-olds where the skill requirement is simple: be up for a game and do not take the scoreboard too seriously.',
    description: [
      'These guided Thursday sessions mix shooting, practice and relaxed games. The organiser is clear that ability does not matter and that enjoying basketball together is the point.',
      'There is no registration, so young players can simply arrive in comfortable sports clothes. The activity is part of a City of Helsinki project creating safe spaces for young people in north-eastern Helsinki.',
    ],
    price: 'Free',
    free: true,
    familyFriendly: true,
    ageNote: 'For young people aged 12–18',
    ...
    transport: [
      ...
      { mode: 'Bike', advice: 'North-eastern Helsinki has useful local cycling routes, with bike parking around community facilities.' },
    ],
  },
  {
    slug: 'kallio-rolling-rainbow-open-skate-2026',
    title: 'Kallio Rolling Rainbow Open Skate',
    category: 'Sports & outdoors',
    startDate: '2026-09-04',
    endDate: '2026-09-04',
    dateLabel: 'Friday 4 September',
    timeLabel: 'Skating 18:00–19:30 · scrimmage until 21:00',
    location: 'Pasila Sports Hall',
    address: 'Radiokatu 22, 00240 Helsinki',
    district: 'Pasila',
    coordinates: { latitude: 60.2039, longitude: 24.9226 },
    blurb: 'Borrow quad skates and protective gear, learn the first moves and stay to watch a scrimmage if roller derby has already got its hooks into you.',
    description: [
      'Kallio Rolling Rainbow’s free Open Skate is a low-pressure version of the opening sessions from its beginners’ course. The club provides skates, pads, a helmet and guidance, so flexible clothes and a willingness to wobble are enough.',
      'Gear fitting starts at 17:30. After skating, participants can stay for an intra-club scrimmage and see what the sport looks like once the basics begin to click.',
    ],
    price: 'Free',
    free: true,
    familyFriendly: false,
    ageNote: '16+',
    bookingNote: 'Advance registration is requested so the club can prepare suitable loan equipment. Arrive from 17:30 for fitting.',
    sourceName: 'Kallio Rolling Rainbow',
    sourceUrl: 'https://www.kalliorollingrainbow.fi/index.php/en/hi-there-english/',
    lastChecked: '24 August 2026',
    transport: [
      { mode: 'Train', advice: 'Pasila station is around a 15-minute walk from the sports hall.' },
      { mode: 'Tram or bus', advice: 'Several buses and trams serve the Radiokatu and Ilmala area.' },
      { mode: 'Bike', advice: 'Pasila is well connected to central and western Helsinki by protected cycling routes.' },
    ],
  },
  {
