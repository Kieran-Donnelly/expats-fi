...
export const exploreListings: ExploreListing[] = [
  ...
  },
  {
    ...
    transport: [{ mode: 'Tram', advice: 'Tram 10 brings you close to the museum buildings.' }, { mode: 'Walk', advice: 'Roughly 15 minutes from the railway station through Esplanadi.' }], website: 'https://www.designmuseum.fi/en/visitors-info/', sourceName: 'Architecture & Design Museum', lastChecked: checked,
  },
  {
  ...
  },
  {
    ...
    transport: [{ mode: 'Tram', advice: 'Take a tram north through Töölö and get off near Töölöntori or Korjaamo.' }, { mode: 'Walk', advice: 'Combine it with a walk around Sibelius Park and Töölönlahti.' }], website: 'https://www.helsinginkaupunginmuseo.fi/en/exhibitions/tram-museum/', sourceName: 'Helsinki City Museum', lastChecked: checked,
  },
  {
  ...
  },
  {
    ...
    transport: [{ mode: 'Train and bus', advice: 'Travel through Espoo by train and connecting bus; use the HSL Journey Planner for the current route.' }, { mode: 'Bike', advice: 'Outdoor routes connect Oittaa towards Nuuksio and Espoo Central Park.' }], website: 'https://www.espoo.fi/en/projects/oittaa-recreational-area', sourceName: 'City of Espoo', lastChecked: checked,
  },
  {
