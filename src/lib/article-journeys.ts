...
export const articleSeoTitles: Record<string, string> = {
  ...
  'guide-entrepreneurship-accountancy': 'Accounting for businesses in Finland: records, VAT and professional help',
  'guide-finance-insurance': 'Insurance in Finland: the cover worth checking',
  'guide-finance-loans': 'Borrowing money in Finland: costs, terms and warning signs',
  'guide-finance-disputes': 'Financial disputes in Finland: evidence, complaints and getting help',
  'guide-telecommunications-and-media-index': 'Phones, internet and television in Finland: getting connected',
  'guide-telecommunications-and-media-telephone': 'Mobile phone plans in Finland: contracts, prepaid and identification',
  'guide-telecommunications-and-media-isp': 'Home internet in Finland: connections, contracts and setup',
  'guide-telecommunications-and-media-television': 'Television and streaming in Finland: services, access and costs',
  'guide-travel-finland-flights': 'Flying to and within Finland: airports, routes and practical checks',
  'guide-travel-finland-cruises': 'Ferries and cruises from Finland: routes, bookings and practical checks',
  'guide-travel-finland-public-transport': 'Public transport in Finland: local tickets, trains and route planning',
  'guide-travel-finland-car-hire': 'Hiring a car in Finland: licences, insurance and winter driving',
  'guide-shopping-in-finland-retailers': 'Shopping in Finland: major retailers, opening hours and payments',
  'guide-shopping-in-finland-loyalty-cards': 'Finnish loyalty cards: benefits, data and household accounts',
  'guide-shopping-in-finland-groceries': 'Grocery shopping in Finland: supermarkets, labels and everyday costs',
  'guide-shopping-in-finland-sales': 'Sales in Finland: discounts, returns and consumer rights',
  'guide-shopping-in-finland-online-shopping': 'Online shopping in Finland: delivery, VAT, returns and scams',
  'guide-shopping-in-finland-index': 'Shopping in Finland: everyday stores, prices and consumer basics',
  'guide-travel-finland-index': 'Travelling around Finland: choosing the right route',
  'guide-travel-finland-finnish-travel-agencies': 'Using a travel agency in Finland: packages, protection and support',
  'guide-living-in-finland-seasons': 'Finland through the seasons: light, weather and everyday life',
  'guide-living-in-finland-fingerpori': 'Understanding Fingerpori: Finnish wordplay without the headache',
  'guide-living-in-finland-finnish-jokes': 'Finnish humour: understatement, wordplay and laughing together',
  'guide-living-in-finland-city-by-city': 'Finding local services anywhere in Finland',
  'guide-living-in-finland-religion': 'Faith and religious communities in Finland',
  'guide-living-in-finland-language-clubs-summer-camps': 'Language clubs and summer camps in Finland',
  'guide-living-in-finland-driving': 'Driving in Finland: licences, vehicles and winter rules',
  'guide-living-in-finland-index': 'Living in Finland: the everyday systems worth understanding',
  'guide-entrepreneurship-lawyers': 'Business lawyers in Finland: when advice is worth getting early',
  'guide-entrepreneurship-development-and-finance': 'Funding a business in Finland: advice, finance and proving the idea',
  'guide-entrepreneurship-employer-information': 'Becoming an employer in Finland: the responsibilities to plan for',
  'guide-entrepreneurship-taxation': 'Business tax in Finland: VAT, income and employer obligations',
  'guide-entrepreneurship-business-space': 'Finding business premises in Finland: what the space must actually do',
  'guide-entrepreneurship-establishing': 'Starting a business in Finland: registrations and first decisions',
  'guide-housing-financial-support-for-housing': 'Help with housing costs in Finland: benefits and affordable homes',
  'guide-housing-tax-advantages-for-housing': 'Housing and tax in Finland: deductions, sales and records',
  'guide-housing-home-loans-in-finland': 'Home loans in Finland: deposits, collateral and monthly costs',
  'guide-housing-investment-property-in-finland': 'Buying an investment property in Finland: costs, tenants and risk',
  'guide-housing-selling-property-in-finland': 'Selling a home in Finland: documents, costs and disclosure',
  'guide-housing-estate-agents-in-finland': 'Estate agents in Finland: services, fees and responsibilities',
  'guide-housing-project-accommodation-in-finland': 'Project accommodation in Finland: planning for teams and longer stays',
  'guide-housing-corporate-accommodation-in-finland': 'Corporate accommodation in Finland: contracts, tax and responsibilities',
  'guide-housing-furnished-apartments-in-finland': 'Furnished apartments in Finland: short stays, costs and contracts',
  'guide-housing-real-estate-terms': 'Finnish property words and abbreviations worth knowing',
  'guide-moving-to-finland-leaving-finland': 'Leaving Finland: the final admin before and after your move',
  'guide-moving-to-finland-relocation-services': 'Relocation services in Finland: what they can and cannot handle',
  'guide-moving-to-finland-storage-warehousing': 'Storage in Finland: access, insurance and contract checks',
  'guide-moving-to-finland-international-movers': 'International movers to Finland: quotes, customs and damage cover',
  'guide-moving-to-finland-address-and-postal-services': 'Your address and post in Finland: registrations, mail and moving notices',
...
export const articleJourneyLinks: Record<string, ArticleJourneyLink[]> = {
  ...
  'guide-finance-index': [
    {
      href: '/resources/guide-finance-account/',
      title: 'Open the account you actually need',
      description: 'Separate everyday banking, cards and strong identification, then compare what each bank can provide.',
    },
    {
      href: '/resources/guide-finance-insurance/',
      title: 'Check the risks your household carries',
      description: 'Home, travel, motor and other policies cover different problems and come with their own exclusions.',
    },
    {
      href: '/resources/guide-finance-loans/',
      title: 'Understand borrowing before comparing rates',
      description: 'Look at the total cost, repayment room and contract terms before treating credit as spare money.',
    },
  ],
  'guide-entrepreneurship-index': [
    {
      href: '/resources/guide-entrepreneurship-establishing/',
      title: 'Choose the structure and registrations',
      description: 'Put the business form, Business ID and tax registers in an order that fits the work you plan to do.',
    },
    {
      href: '/resources/guide-entrepreneurship-accountancy/',
      title: 'Build the bookkeeping routine early',
      description: 'Records, invoices, payroll and tax reporting are easier to set up before transactions begin piling up.',
    },
    {
      href: '/resources/guide-entrepreneurship-taxation/',
      title: 'Understand the taxes around the business',
      description: 'VAT, income tax and employer obligations are separate questions, even when one accountant helps with all three.',
    },
  ],
  'guide-telecommunications-and-media-index': [
    {
      href: '/resources/guide-telecommunications-and-media-telephone/',
      title: 'Choose a mobile plan',
      description: 'Compare prepaid and contract options, coverage, roaming, identification and the real monthly price.',
    },
    {
      href: '/resources/guide-telecommunications-and-media-isp/',
      title: 'Connect the home',
      description: 'Check what technology already reaches the building before signing a broadband contract.',
    },
    {
      href: '/resources/guide-telecommunications-and-media-television/',
      title: 'Sort television and streaming',
      description: 'Work out the building signal, devices, channel rights and subscriptions your household actually wants.',
    },
  ],
  'guide-travel-finland-index': [
    {
      href: '/resources/guide-travel-finland-public-transport/',
      title: 'Plan trains, buses and local transport',
      description: 'Match the national journey with the local connection and check the operator before travelling.',
    },
    {
      href: '/resources/guide-travel-finland-flights/',
      title: 'Compare the whole flight journey',
      description: 'Airport transfers, baggage, connections and winter disruption matter as much as the headline fare.',
    },
    {
      href: '/explore/day-trips/',
      title: 'Find a day trip from Helsinki',
      description: 'Choose a realistic outing by travel time, season and how forgiving the return connection is.',
    },
  ],
  'guide-shopping-in-finland-index': [
    {
      href: '/resources/guide-shopping-in-finland-retailers/',
      title: 'Learn where everyday things are sold',
      description: 'Use the major chains as a starting map, then check the branch, opening hours and current stock.',
    },
    {
      href: '/resources/guide-shopping-in-finland-groceries/',
      title: 'Make the weekly food shop easier',
      description: 'Compare supermarkets, labels, unit prices, specialist shops and online delivery without overcomplicating dinner.',
    },
    {
      href: '/resources/guide-shopping-in-finland-online-shopping/',
      title: 'Shop online with fewer surprises',
      description: 'Check the seller, delivery, VAT, customs, returns and payment protection before ordering.',
    },
  ],
  'guide-living-in-finland-index': [
    {
      href: '/start-here/',
      title: 'Start with the first practical steps',
      description: 'Put registration, banking, healthcare and the first few months into a manageable order.',
    },
    {
      href: '/culture/',
      title: 'Understand ordinary Finnish life',
      description: 'Warm, practical answers about communication, homes, saunas, workplaces, holidays and making friends.',
    },
    {
      href: '/learn-finnish/',
      title: 'Find a Finnish-learning route',
      description: 'Choose courses, practice groups and everyday habits that fit your level and the life you are building.',
    },
  ],
  'guide-housing-index': [
    {
