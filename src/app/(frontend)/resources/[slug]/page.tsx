  ...
  return (
    <main id="main"><div className="shell detail-shell article-page">
      ...
      <div className="article-page__layout">
        ...
        <aside className="article-aside"><div><strong>About this guide</strong><p>This article was migrated from the existing Expats.fi library and can now be reviewed and updated in Payload.</p></div><div><strong>Check before acting</strong><p>Immigration, tax and benefit rules can change. Confirm decisions with the relevant Finnish authority.</p></div></aside>
      </div>
    </div></main>
  )
}
