  ...
  const heroImage = slug === 'finland-in-twelve-turning-points'
    ...
    : slug === 'finnish-names-worth-knowing'
      ...
      : slug === 'historic-finland-you-can-visit'
        ...
        : undefined
  return <EditorialGuideDetail guide={guide} guides={cultureGuides} hubHref="/culture/" hubLabel="How Finland actually works" relatedHeading="More of the cultural bits" reviewedAt="2026-08-27" heroImage={heroImage} />
}
