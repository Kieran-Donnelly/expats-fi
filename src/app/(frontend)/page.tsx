    ...
    <main id="main">
      <section className="home-hero">
        <div className="shell home-hero__inner">
          ...
          <div className="popular-links"><span>Popular right now</span><Link href="/resources/?q=residence+permit">residence permit</Link><Link href="/resources/?q=Finnish">learning Finnish</Link><Link href="/businesses/">expat businesses</Link></div>
