      ...
      <article className="shell news-story">
        ...
        <div className="news-story__layout">
          ...
          <aside className="news-story__aside">
            ...
            <div><span>Something changed?</span><p>Spotted an update or a detail we missed?</p><a href="mailto:moi@expats.fi?subject=News%20story%20update">Give us a heads-up</a></div>
          </aside>
        </div>
      </article>
