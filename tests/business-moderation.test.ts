...
import { businessVerificationLabel, isPubliclyVerifiedBusiness } from '../src/lib/business-verification'
...
test('whitelists moderation actions and exposes public verification labels', () => {
  ...
  assert.equal(businessVerificationLabel('owner-verified'), 'Owner verified')
